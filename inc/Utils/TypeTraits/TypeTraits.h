...
namespace SR_UTILS_NS {
    ...
    template<typename T, typename Compare> class Set;
    template<typename Key, typename Value, typename Compare> class Map;
    ...
    template<typename T, typename Compare> struct InnerType<Set<T, Compare>> {
        using type = typename InnerType<T>::type;
    };
    ...
    template<typename Key, typename Value, typename Compare> struct InnerType<Map<Key, Value, Compare>> {
        using type = typename InnerType<Value>::type;
    };
    ...
    template<typename T> struct IsVector<SR_UTILS_NS::Vector<T>> : std::true_type {};
    template<typename T> constexpr bool IsVectorV = IsVector<RemoveQualifiersT<T>>::value;

    template<typename T> struct IsSet : std::false_type {};
    template<typename T, typename Compare> struct IsSet<Set<T, Compare>> : std::true_type {};
    template<typename T> constexpr bool IsSetV = IsSet<RemoveQualifiersT<T>>::value;

    template<typename T> struct IsMap : std::false_type {};
    template<typename Key, typename Value, typename Compare> struct IsMap<Map<Key, Value, Compare>> : std::true_type {};
    template<typename T> constexpr bool IsMapV = IsMap<RemoveQualifiersT<T>>::value;
    ...
    template<> struct SupportsNullptrComparison<SR_UTILS_NS::String> : std::false_type {};
    template<typename T> struct SupportsNullptrComparison<SR_UTILS_NS::Vector<T>> : std::false_type {};
