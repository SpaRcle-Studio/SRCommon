...
namespace SR_HTYPES_NS {
    ...
    template<typename T> SafeVar<T>::operator const T&() const noexcept { return m_data; } /// NOLINT
    template<typename T> SafeVar<T>::operator bool() const noexcept { return m_data; } /// NOLINT
