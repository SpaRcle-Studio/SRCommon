...
namespace SR_UTILS_NS {
    ...
    public:
        ...
        void SetMatrix(const SR_UTILS_NS::Optional<SR_MATH_NS::FVector3>& translation,
                       const SR_UTILS_NS::Optional<SR_MATH_NS::Quaternion>& rotation,
                       const SR_UTILS_NS::Optional<SR_MATH_NS::FVector3>& scale) override;
        ...
        void LookAt(const SR_MATH_NS::FVector3& position, const SR_MATH_NS::FVector3& up) override;
    ...
    protected:
        ...
        /// @property @setter(SetSkew) @defaultValue(SR_MATH_NS::FVector3::One()) @drag(0.01f) @hidden
