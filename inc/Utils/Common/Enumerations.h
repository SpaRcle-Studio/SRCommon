...
namespace SR_UTILS_NS {
    ...
    SR_ENUM_NS_CLASS_T(MigrationResult, int8_t,
        Unhandled, /// необработан. пропускаем миграцию и загружаем как есть
        Success,   /// успешно смигрировали
        Failed,    /// не удалось смигрировать, пропускаем миграцию и загружаем как есть
        Fatal      /// фатальная ошибка, не можем продолжать миграцию, не загружаем
    );
