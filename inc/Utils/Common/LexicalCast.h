...
#ifndef SR_ENGINE_UTILS_LEXICAL_CAST_H
#define SR_ENGINE_UTILS_LEXICAL_CAST_H
        ...
        try {
            if constexpr (std::is_same<T, bool>()) {
                ...
                if (!hasSharp && !IsHexString(str)) {
                    const auto&& pIt = SR_MATH_NS::SR_COLOR_PALETTE.find(Details::StringFormatHashStrView(str));
...
#endif //SR_ENGINE_UTILS_LEXICAL_CAST_H
